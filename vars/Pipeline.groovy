    ...
    if (jobName == "test") {
        ...
        pipeline {
            ...
            stages {
              ...
              echo '  PRODUCT_LATEST_URL: ${PRODUCT_LATEST_URL}' >> ${JOB_CONFIG_YAML_PATH}
              echo '  PRODUCT_LATEST_BRANCH: ${PRODUCT_LATEST_BRANCH}' >> ${JOB_CONFIG_YAML_PATH}
              echo '  WUM_CHANNEL: ${WUM_CHANNEL}' >> ${JOB_CONFIG_YAML_PATH}
              echo '  PRODUCT_CODE: ${PRODUCT_CODE}' >> ${JOB_CONFIG_YAML_PATH}
              echo '  PRODUCT_VERSION: ${PRODUCT_VERSION}' >> ${JOB_CONFIG_YAML_PATH}
