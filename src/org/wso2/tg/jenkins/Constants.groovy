...
class Constants {
    ...
    static final def WUM_UAT_APPKEY          = "WUM_UAT_APPKEY"
    static final def WUM_USERNAME             = "WUM_USERNAME"
    static final def WUM_PASSWORD             = "PASSWORD"
    ...
    static final def INFRASTRUCTURE_REPOSITORY     = "INFRASTRUCTURE_REPOSITORY"
}
